...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <span class="navbar-organizer w-100">{{$name}}</span>
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <a class="nav-link" id="logout" href="{{route('home')}}">Đăng xuất</a>
        </li>
    </ul>
</nav>
                ...
                @foreach($events as $event)
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <a href="events/detail.html/{{$event->slug}}" class="btn text-left event">
                                <div class="card-body">
